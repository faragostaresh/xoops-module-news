...
$index_admin->addInfoBoxLine(_NEWS_AM_INDEX_ADMENU1, _NEWS_AM_INDEX_TOPICS, $topic_handler->NewsTopicCount());
$index_admin->addInfoBoxLine(_NEWS_AM_INDEX_ADMENU2, _NEWS_AM_INDEX_CONTENTS, $story_handler->NewsStoryAllCount());
$index_admin->addInfoBoxLine(_NEWS_AM_INDEX_ADMENU2, _NEWS_AM_INDEX_CONTENTS_OFFLINE, $story_handler->NewsStoryOfflineCount($story_infos));
$index_admin->addInfoBoxLine(_NEWS_AM_INDEX_ADMENU2, _NEWS_AM_INDEX_CONTENTS_EXPIRE, $story_handler->NewsStoryExpireCount($story_infos));
...
// Call template file
$xoopsTpl->display(XOOPS_ROOT_PATH . '/modules/news/templates/admin/news_index.tpl');

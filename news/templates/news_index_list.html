<div class="news-index-list">
    <div class="itemList">
        <ul>
            ...
            <li>
                <h3><{if $content.story_important}><span class="red bold"><{$smarty.const._NEWS_MD_IMPORTANT}></span><{/if}><a
                ...
                <div class="pad2">
					...
					<span class="itemPoster">
						<a href="<{$xoops_url}>/user.php?id=<{$content.story_uid}>" title="<{$content.owner}>"><{$content.owner}></a><{if $alluserpost}> (<a

<div class="news-archive">
        ...
        <table class="outer">
            ...
            <tr class="even">
                <td><a title="<{$month.string}> <{$year.number}>"
                       href="<{$xoops_url}>/modules/<{$module}>/archive.php?year=<{$year.number}>&amp;month=<{$month.number}>"><{$month.string}>
                    <{$year.number}></a></td>
            </tr>
            <{/foreach}>
            <{/foreach}>
    ...
    <div class="marg2 pad2 center"><a title="<{$smarty.const._NEWS_MD_ARCHIVE_TOTAL}>"
                                      href="<{$xoops_url}>/modules/<{$module}>/archive.php"><{$smarty.const._NEWS_MD_ARCHIVE_TOTAL}></a>
    </div>
    <{/if}>
